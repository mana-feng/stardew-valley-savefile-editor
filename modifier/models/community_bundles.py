...
class Bundle(BaseProxy):
    ...
    def __init__(self, element, data_key, data_value, submitted_booleans):
        ...
        self.data_key = data_key # "Pantry/0"
        self.data_value = data_value # "Spring Crops/..."
        self.submitted_booleans = submitted_booleans # list of bools
    ...
    def _load_bundles(self):
        ...
        if bundles_elem is not None:
            for item in bundles_elem.findall("item"):
                ...
                # 寻找匹配的定义
                # bundleData 的 key 格式是 "Room/SpriteIndex"
                matching_key = None
                matching_value = None
